            ...
            <div class="sm:col-span-4">
              ...
              <div class="mt-2">
                <div
                  ...
                  <span class="flex select-none items-center pl-3 text-gray-500 sm:text-sm">buylify.com/</span>
            ...
            <div class="sm:col-span-3">
              ...
              <div class="mt-2">
                <select id="country" name="country" autocomplete="country-name"
                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6 bg-white">
